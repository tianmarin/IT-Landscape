...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	* @author Cristian Marin
	*/
	function ita_register_class_submenu_page() {
		global $ita_vars;
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	function add_new( $postvs ){
		ita_add_new_class_row($this->tbl_name, $postvs, $this->db_fields, $this->name_single );
	}
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	/**
	...
	*/
	function update( $postvs ){
		ita_edit_class_row($this->tbl_name, $postvs, $this->db_fields, $this->name_single );
	}
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	/**
	...
	*/
	function bulk_delete( $postvs ){
		ita_bulk_delete( $this->tbl_name,$postvs,$this->name_plural);
	}
