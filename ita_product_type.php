...
class PRODUCT_TYPE_CLASS extends ITA_CLASS{
	
	function __construct(){
		global $wpdb;
		global $ita_vars;
		$this->class_name	= 'product_type';
		$this->name_single	= 'Tipo de Producto';
		$this->name_plural	= 'Tipos de Producto';
...
global $PRODUCT_TYPE;
$PRODUCT_TYPE =new PRODUCT_TYPE_CLASS();
?>