...
class DB_ENGINE_CLASS extends ITA_CLASS{
	
	function __construct(){
		global $wpdb;
		global $ita_vars;
		$this->class_name	= 'db_engine';
		$this->name_single	= 'Motor de DB';
		$this->name_plural	= 'Motores de DB';
