...
class INTERFACE_CLASS extends ITA_CLASS{
	
	function __construct(){
		global $wpdb;
		global $ita_vars;
		$this->class_name	= 'interface';
		$this->name_single	= 'Interfaz';
		$this->name_plural	= 'Interfaces';
		$this->icon			= '<i class="fa fa-external-link"></i>';
		...
		$this->db_fields	= array(
			...
			*/
			...
			'ip'		=> array('field_type'=>'text'		,'required'=>false,	'size'=>'M',	'maxchar'=>50,		'field_desc'=>'IPs'),
		);
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	function class_menu_main(){
		...
		$titles		= array('id',$DB['shortname']['field_desc'],$DB['name']['field_desc'],$DB['ip']['field_desc']);
		ita_class_menu_main(
			$title,
			$this->menu_slug,
			$add_new,
