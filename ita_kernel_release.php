...
class KERNEL_RELEASE_CLASS extends ITA_CLASS{
	
	function __construct(){
		global $wpdb;
		global $ita_vars;
		$this->class_name	= 'kernel_release';
		$this->name_single	= 'Release de Kernel';
		$this->name_plural	= 'Release de Kernel';
		$this->icon			= '<i class="fa fa-adjust"></i>';
...
$KERNEL_RELEASE =new KERNEL_RELEASE_CLASS();
?>